  ...
  return (
    <div className='searchDiv grid gap-10 bg-greyIsh rounded-[10px] p-[3rem]'>
      ...
      <form action="">
        ...
        <div className='firstDiv flex justify-between items-center rouded-[8px] gap-[10px] bg-white p-5 shadow-lg shadow-greyIsh-700'>
          ...
          <button className='bg-blueColor h-full p-5 rounded-[10px] text-white cursor-pointer hover:bg-blue-300'>Search</button>
      ...
      <div className="secDiv flex items-center gap-10 justify-center">
        ...
        <div className="singleSearch felx items-center gap-2">
